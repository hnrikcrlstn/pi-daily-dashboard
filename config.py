...
MONITOR_TRANSIT_SECTION_Y_START = 100
...
MONITOR_TRANSIT_RECTANGLE_WIDTH = (MONITOR_RESOLUTION_WIDTH - MONITOR_PADDING_X * 4) / MONITOR_TRANSIT_COLUMS - 2 * MONITOR_PADDING_X